...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id) {
		 ...
		 * timeout_express:发送请求的时间，格式"yyyy-MM-dd HH:mm:ss"
		 ...
		 */
		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"0.01\",\"subject\":\"O计平台缴费\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
