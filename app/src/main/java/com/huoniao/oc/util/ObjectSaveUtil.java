...
public class ObjectSaveUtil {  
    ...
    private final static String FILENAME = "user_data_save";  
      ...
      public static byte[] StringToBytes(String data){  
          ...
          {  
              ...
              if(hex_char1 >= '0' && hex_char1 <='9')  
                  ...
                  int_ch3 = (hex_char1-55)*16; //// LineChartDataBean 的Ascll - 65
              else  
                  return null;  
              i++;  
              ...
              if(hex_char2 >= '0' && hex_char2 <='9')  
                  ...
                  int_ch4 = hex_char2-55; //// LineChartDataBean 的Ascll - 65
              else  
                  return null;  
