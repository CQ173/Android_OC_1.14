package com.huoniao.oc.common.sideslip_listview;
...
import com.huoniao.oc.common.sideslip_listview.pulltorefresh.interfaces.OnXScrollListener;
import com.huoniao.oc.common.sideslip_listview.pulltorefresh.view.PullToRefreshListFooter;
import com.huoniao.oc.common.sideslip_listview.pulltorefresh.view.PullToRefreshListHeader;
import com.huoniao.oc.common.sideslip_listview.swipemenu.adapter.SwipeMenuAdapter;
...
import com.huoniao.oc.common.sideslip_listview.swipemenu.interfaces.OnSwipeListener;
import com.huoniao.oc.common.sideslip_listview.swipemenu.interfaces.SwipeMenuCreator;
import com.huoniao.oc.common.sideslip_listview.swipemenu.view.SwipeMenuLayout;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if ((mTouchView == null || !mTouchView.isActive()) && Math.pow(dx, 2) / Math.pow(dy, 2) <= 3) {
				if (getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
					...
					invokeOnScrolling();
					//如果把上拉加载更多禁用掉请在下面这个判断中 加上   && mEnablePullLoad
				} else if ((mFooterView.getBottomMargin() > 0 || deltaY < 0)&&getLastVisiblePosition()==getCount()-1  && mEnablePullLoad)  {
		...
		case MotionEvent.ACTION_UP:
			mLastY = -1; // reset
			if (mEnablePullLoad && mFooterView.getHeight()>0 && mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA&& getLastVisiblePosition()==getCount()-1) {
				startLoadMore();
				resetFooterHeight();
	...
	public void setPullToLoadMoreData(){
		mFooterView.setFooterLoadStateListenter(new PullToRefreshListFooter.FooterLoadState() {
			@Override
			public void setNoMormData(TextView textView) {
