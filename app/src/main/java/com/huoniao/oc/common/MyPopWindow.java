 ...
 * PopWindow的封装   不停的写重复的就封装了一下
 *
 */

public class MyPopWindow implements PopupWindow.OnDismissListener, View.OnTouchListener {
    ...
    private boolean onTouchListener = false;
    ...
    private PopupWindow build(){
       ...
       // mPopupWindow.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));  //设置了点击返回键就可以消失
     ...
     * @param dismiss
     */
    public void keyCodeDismiss(boolean dismiss){
        if(dismiss){
    ...
    public static class PopupWindowBuilder{
        ...
        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new MyPopWindow(context);
        }
         ...
         * @return
         */
        public PopupWindowBuilder setOnTouchTouchable(boolean  touch){
            mCustomPopWindow.onTouchListener = touch;
            return this;
        }
        /**
         * 设置背景变暗的值
