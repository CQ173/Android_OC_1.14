...
public class CircleView extends TextView{
     ...
     */
    public CircleView(Context context, View target) {
     ...
     */
    public CircleView(Context context, TabWidget target, int index) {
    ...
    public CircleView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
